...
// Ecrit le 29/09/2017 par Pierre DELAUNAY
    ...
    if ( $nouveauMdp != $confirmationMdp ) {
       ...
       include_once ('page-5-3-vue.php');
         ...
         if (strlen($nouveauMdp) < 8 ) {
             // vérification 8 caractères mini
             $message = 'Le nouveau mot de passe doit contenir au moins 8 caractères !';
             $typeMessage = 'avertissement';
             include_once ('page-5-3-vue.php');
         }
         else {
             if (preg_match("#^(.+[A-Z].+)|([A-Z].+)|(.+[A-Z])$#", $nouveauMdp) == false) {
                // vérification 1 lettre majuscule
                ...
                include_once ('page-5-3-vue.php');
                 ...
                 if (preg_match("#^.+[a-z].+$#", $nouveauMdp) == false) {
                    // vérification 1 lettre minuscule
                    ...
                    include_once ('page-5-3-vue.php');
                     ...
                     if (preg_match("#^.+[0-9].+$#", $nouveauMdp) == false) {
                        ...
                        $message = 'Le nouveau mot de passe doit contenir au moins un chiffre (0 à 9) !';
                        $typeMessage = 'avertissement';
                        include_once ('page-5-3-vue.php');                        
                     }
                     else {
